...
def structure(args):
    ...
    motif_abd_table, motif_lab, merged_weights_dict = pipeline_functions.select_motifs_pip(keywords_dict, linkage_specific=linkage_specific, only_substructures_start_from_root=only_substructures_start_from_root, reverse_dict = reverse_dict, core=core, drop_parellel=False, drop_diff_abund=False, select_col= [])
